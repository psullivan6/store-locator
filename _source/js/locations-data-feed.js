 ...
 * @private
 */
LocationsDataFeed.prototype.FEATURES_ = new storeLocator.FeatureSet(
 ...
 */
LocationsDataFeed.prototype.getFeatures = function() {
 ...
 */
LocationsDataFeed.prototype.parse_ = function(csv) {
  var stores = [];
  var rows = csv.split('\n');
 ...
 * @return {string}
 */
LocationsDataFeed.prototype.join_ = function(arr, sep) {
  var parts = [];
 ...
 * @return {Array.<string>}
 */
LocationsDataFeed.prototype.parseRow_ = function(row) {
  // Strip leading quote.
  if (row.charAt(0) == '"') {
    row = row.substring(1);
  }
 ...
 * @return {Object}
 */
LocationsDataFeed.prototype.toObject_ = function(headings, row) {
  var result = {};
